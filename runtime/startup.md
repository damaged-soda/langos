...
3) 业务开发：进入需求/方案/编码/评审流程（需要业务文档目录）
```
...
- “业务开发”：进入该模式后，再判断业务文档目录：  
  - 若检测到目录（如 workspace-docs/workspace），可提示“使用该目录或改为其他目录”；  
  - 若未检测到，提示“指定业务目录”或“创建空业务骨架（workspace/{repos,projects,domain,specs,adr,archive}）”；  
